...
$query = "SELECT * FROM pages WHERE page_name='contact_en'";
        ...
        <div class="wrapper">
            ...
            <div class="content" data-simplebar>
                <div class="section mt-0">
                    <h2 class="title title-h1 title_separate">Contact Me</h2>
                </div>
                ...
                <form id="contact-form" class="contact-form" method="post" action="/functions/contact_form">
                    <div class="row">
                        <div class="form-group col-12 col-md-6">
                            ...
                            <input type="text" class="input input_icon form-control" id="name" name="name" placeholder="Name" required="required" autocomplete="on">
                        </div>
                        <div class="form-group col-12 col-md-6">
                        ...
                        <div class="form-group col-12 col-md-12">
                            ...
                            <textarea class="textarea form-control input_icon" id="message" name="message" placeholder="Message" rows="4" required="required"></textarea>
                        </div>
                    </div>
